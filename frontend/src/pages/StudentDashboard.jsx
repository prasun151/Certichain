...
import { getStudentCredentials, isContractDeployed, getAppId } from '../utils/algorand';
          ...
          <Card className="text-center py-6">
            {isContractDeployed() ? (
              <>
                ...
                <p className="text-muted">Contract: {getAppId()}</p>
              </>
            ) : (
              <>
                ...
                <p className="text-muted">ASA Mode</p>
              </>
            )}
          </Card>
        </motion.div>
